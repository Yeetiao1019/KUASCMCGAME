 ...
 * @author yee
 */
public class play6gui extends javax.swing.JFrame {
    ...
    public play6gui() {
        try{
            soundfile = new FileInputStream("ca.mp3");
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/kuascmcgame/choose/da.png"))); // NOI18N
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 170, 110, 190));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(play6gui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
